...
dedicated to one of the following python generators:
...
________________________________________________________________________
  ...
  ***  Used  for  calculating cross sections  for a given center of mass 
       energy range.
  ...
  ***  For more information on how  to use it please refer to  the  README
       in  the dedicated folder "Pythia8_Macro_Files_Generator".
